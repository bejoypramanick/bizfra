...
class _HomeState extends State<CameraWidget> {
    ...
    try {
      if (controller != null && controller!.value.isInitialized) {
       ...
       // final Uint8List pictureBytes = await  File(picture.path).readAsBytes();
        ...
        print("Picture captured: ${picture.path}"); // Debugging: Check the picture path
        setState(() {
          image = picture;
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: widget.photoData != null ? Image.memory(widget.photoData, height: 300) : Text("No image captured"),
              )
            ],
          ),
        ),
          ...
          children: [
            NextButtonWidget(
              onPressed: () {
                ...
                registrationBloc.add(SummaryDetailsLoadedEvent());
